            ...
            <div>
              ...
              <div className="relative rounded-xl shadow-xs">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-11 py-2.5 bg-surface-container-low border border-outline-variant rounded-xl text-sm font-semibold text-primary placeholder:text-on-surface-variant focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((visible) => !visible)}
                  className="absolute inset-y-0 right-0 px-3.5 flex items-center text-primary hover:text-secondary cursor-pointer"
